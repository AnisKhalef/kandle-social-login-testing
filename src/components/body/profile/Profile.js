...
function Profile() {
    ...
    const changeprofilePic = async(e) => {
        ...
        try {
            ...
            setLoading(true)
            const res = await axios.post('/api/upload_profilePic', formData, {
    ...
    const handleUpdate = () => {
        if(name || profilePic) updateInfor()
            ...
            <div className="col-left">
                ...
                <div className="profilePic">
                    ...
                    <span>
                        ...
                        <p>Change</p>
                        <input type="file" name="file" id="file_up" onChange={changeprofilePic} />
                    </span>
                </div>
